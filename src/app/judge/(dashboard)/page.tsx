        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Competition Score</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Achievement</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              <span className="inline-block text-2xl font-bold">4hr 3m</span>

              <span className="block text-gray-500">Average Coding Time</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
