...
const PricingCard3: NextPage = () => {
  return (
    <div className="absolute h-[calc(100%_-_326px)] w-[calc(100%_-_1038px)] top-[326px] right-[684px] bottom-[0px] left-[354px] rounded-2xl box-border text-left text-sm text-gray-200 font-space-grotesk border-[1px] border-solid border-lightsteelblue-100">
      <h2 className="m-0 absolute top-[33px] left-[41px] text-5xl leading-[30px] font-medium font-inherit text-blueviolet-100 flex items-center w-[82.9px] h-[30px]">
        Starter
      </h2>
      <b className="absolute top-[79px] left-[41px] text-[47.81px] leading-[60px] flex items-center w-[81.7px] h-[60px]">
        $10
      </b>
      ...
      <button className="cursor-pointer p-0 bg-blueviolet-100 absolute w-[calc(100%_-_82px)] top-[calc(50%_-_204px)] right-[41px] left-[41px] rounded-lg box-border h-[46px] border-[1px] border-solid border-blueviolet-100">
        <div className="absolute top-[calc(50%_-_11px)] left-[64.8px] text-base leading-[20px] font-medium font-space-grotesk text-white text-center flex items-center justify-center w-[94.8px] h-[21px]">
          Choose Plan
        </div>
      </button>
      ...
      <div className="absolute top-[581px] left-[41px] leading-[21px] text-limegreen flex items-center w-[4.1px] h-[21px]">
        ✓
      </div>
      <div className="absolute top-[582px] left-[65px] leading-[21px] flex items-center w-[179.8px] h-[39px]">
        <span className="[line-break:anywhere] w-full">
          <p className="m-0">Zapier integration (coming</p>
          <p className="m-0">soon)</p>
        </span>
      </div>
      <div className="absolute top-[651px] left-[41px] leading-[21px] text-limegreen flex items-center w-[4.1px] h-[21px]">
        ✓
      </div>
      <div className="absolute top-[652px] left-[65px] leading-[21px] flex items-center w-[173.4px] h-[39px]">
        <span className="[line-break:anywhere] w-full">
          <p className="m-0">Slack integration (coming</p>
          <p className="m-0">soon)</p>
        </span>
      </div>
    </div>
